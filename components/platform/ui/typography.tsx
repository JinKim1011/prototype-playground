...
export const typographyStyles = cva("", {
  variants: {
    variant: {
      "heading": "text-[1.25rem] leading-[1.3] font-bold",
      "heading-small": "text-[1.125rem] leading-[1.3] font-semibold",
      "body-large": "text-[1rem] leading-[1.7] font-normal",
      ...
      "label-large": "text-[0.9375rem] leading-[1.3] font-normal",
      "label": "text-[0.875rem] leading-[1.3] font-normal",
      "label-small": "text-[0.8125rem] leading-[1.3] font-normal",
    },
  },
  defaultVariants: {
    variant: "body",
